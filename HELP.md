...
* [JDBC API](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/#data.sql)
* [Validation](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/#io.validation)
