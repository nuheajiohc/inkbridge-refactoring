...
class MemberOrderControllerTest {
    ...
    void testGetOrder() throws Exception {
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/auth/members/{memberId}/orders/{orderCode}", 1L, "orderCode")
            ...
            .andDo(document("order/member-get/order-code/200",
    ...
    void testGetOrderByOrderCode_not_found() throws Exception {
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/auth/members/{memberId}/orders/{orderCode}", 1L, "orderCode")
            ...
            .andDo(document("order/member-get/order-code/404",
                preprocessRequest(prettyPrint()),
                preprocessResponse(prettyPrint())));
    }
    ...
    void testGetOrderList() throws Exception {
        ...
        given(orderFacade.getOrderListByMemberId(any(), any())).willReturn(new PageImpl<>(List.of(response)));

        mockMvc.perform(RestDocumentationRequestBuilders.get("/api/auth/members/{memberId}/orders", 1L)
                .queryParam("page", "1")
                .queryParam("size", "10")
                .header("Authorization-id", 1L)
                .contentType(MediaType.APPLICATION_JSON)
            ...
            .andDo(document("order/member/page-get-200",
                preprocessRequest(prettyPrint()),
                preprocessResponse(prettyPrint()),
